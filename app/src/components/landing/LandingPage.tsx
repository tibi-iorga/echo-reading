...
const faqs = [
  {
    question: 'Do I need an API key to use Echo?',
    answer:
      'Only for AI chat. You can upload PDFs, highlight, annotate, take notes in the Canvas, and export without an API key. To chat with your documents, add your own OpenAI or Anthropic key in Settings.',
  },
  {
    question: 'Is my API key safe?',
    answer:
      'Your key is encrypted on your device using the Web Crypto API and stored in your browser\'s IndexedDB. It is never sent to our servers. When you ask a question, it goes directly from your browser to the provider you chose.',
  },
  {
