...
export function FileSelector({ onFileSelect }: FileSelectorProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-900 overflow-hidden">
      <div className="flex-1 overflow-y-auto">
        <div className="flex items-center justify-center min-h-full py-8">
          <div className="text-center max-w-2xl mx-auto px-4 sm:px-6 w-full">
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4">Echo</h1>
            ...
            <button
              ...
              className="px-6 py-3 bg-blue-500 dark:bg-blue-600 text-white rounded-lg hover:bg-blue-600 dark:hover:bg-blue-700 font-medium transition-colors shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 mb-8"
            >
              Choose PDF File
            </button>
          </div>
      ...
      <div className="flex-shrink-0 py-4 px-4 sm:px-6 flex justify-center items-center text-xs text-gray-400 dark:text-gray-500 border-t border-gray-200 dark:border-gray-800">
